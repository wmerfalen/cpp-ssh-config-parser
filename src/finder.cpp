...
std::ifstream::pos_type filesize(std::string_view filename) {
...
std::optional<keys> from_string(std::string_view k) {
#define STR_TO_ENUM(A) if(lower_case_compare(k,#A)){ return keys::A; }
...
std::optional<std::string> to_string(keys k) {
